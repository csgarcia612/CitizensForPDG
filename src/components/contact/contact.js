  ...
  render() {
    ...
    return (
      <div className='contactPageContainer'>
        ...
        <div className={showEmailErr ? 'showEmailErr' : 'hideEmailErr'} onClick={this.toggleEmailErr}>
          <p>
        ...
        <div className={showEmailWarn ? 'showEmailWarn' : 'hideEmailWarn'} onClick={this.toggleEmailWarn}>
          <p>
